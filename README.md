...
- **Posterior Keratometry**: Optional PK measurements (for the Zeiss IOLMaster 700)
- **Total Keratometry**: Gaussian thick-lens formula with a modified Liou-Brennan scaling to match the IOLMaster 700 TK values
